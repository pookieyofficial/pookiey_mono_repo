...
const POOKIEY_WEB_URL = process.env.EXPO_POOKIEY_WEB_URL;
    ...
    <SafeAreaView style={styles.safe} edges={['top', 'left', 'right']}>
      <View style={styles.container}>
        ...
        <View style={styles.bottomBar}>
          <TouchableOpacity style={styles.primaryButton} onPress={handleOpenWeb}>
            <ThemedText type="bold" style={styles.primaryButtonText}>
              Buy Premium on Web
            </ThemedText>
          </TouchableOpacity>
        </View>
